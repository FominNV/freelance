...
// TODO: отрефакторить
import {
  computed, reactive, onBeforeUnmount, ref,
} from 'vue';
import { StyleValue } from 'vue/types/jsx';
import { ClassPropsType } from '../../@types/props';
import { RrSliderModelImpl } from './RrSliderModelImpl';

export interface RrSliderPropsImpl {
  /** модель значений */
...
const props = withDefaults(defineProps<RrSliderPropsImpl>(), {
  min: 0,
  max: 100,
...
const model = reactive<RrSliderModelImpl>({
