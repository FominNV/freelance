...
export interface UiPaginationDropdownPropsImpl {
  /** текст надписи */
  pageLabel?: string;
...
const props = withDefaults(defineProps<UiPaginationDropdownPropsImpl>(), {
...
const onRangeSelectedHandler = (value: UiPaginationPageSizesListItemImpl, closePopoverCallback: (delay?: number) => void) => {
  rangeChange();
