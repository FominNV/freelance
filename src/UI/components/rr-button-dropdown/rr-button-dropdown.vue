...
import RrPopover from '../ui-popover/ui-popover.vue';

export interface RrButtonDropdownPropsImpl {
...
const props = withDefaults(defineProps<RrButtonDropdownPropsImpl>(), {
  shape: 'normal',
  size: 'md',
  get theme() {
...
const popover = ref<typeof RrPopover | null>(null);
